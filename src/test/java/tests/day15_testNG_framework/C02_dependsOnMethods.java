...
public class C02_dependsOnMethods {
    ...
    public void amazonTest(){
        ...
        // driver'i Driver classindan kullandik.
    ...
    @Test (dependsOnMethods = "amazonTest") // Once amazonTest calissin diyor.
    ...
    @Test(priority = -1 , dependsOnMethods = "nutellaTest") // Once nutellaTest calissin
